    ...
    <div className="p-4 flex flex-col gap-6">
      <div className="bg-white dark:bg-background border shadow rounded-lg p-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-200">Edit Sale Request</h2>
          <Button
            variant="default"
            size="sm"
        ...
        <form onSubmit={handleUpdate}>
          <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
            ...
            {renderReadonly(
              "Price/Unit",
              request?.price_per_unit != null ? `₹ ${request?.price_per_unit}` : "-"
            )}
            {renderReadonly(
              "Created At",
          ...
          <div className="flex justify-end mt-4">
            <Button type="submit" disabled={isLoading} variant="default" size="sm" className="gap-2">

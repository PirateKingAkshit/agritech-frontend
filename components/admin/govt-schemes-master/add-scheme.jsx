                  ...
                  <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => handleTranslationChange(index, e)}
                        disabled={type === "View"}
                        className="w-full border border-border rounded px-3 py-2 text-sm bg-background dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-primary/50"
                      >

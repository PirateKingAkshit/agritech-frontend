...
const axiosInstance = (router) => {
  // Retrieve the token from cookies
  // const token = getCookie('token');
  const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4N2Y3ZjcyMGZmODI3MTEyMWViYzY3YyIsInBob25lIjoiOTk5OTk5OTk5OSIsInJvbGUiOiJBZG1pbiIsImlhdCI6MTc1MzMzNTE1NywiZXhwIjoxNzUzMzc4MzU3fQ.2dZC55rtQhAZao0A54a9icUUija-R6ZB3lnBZeuHOsA"
